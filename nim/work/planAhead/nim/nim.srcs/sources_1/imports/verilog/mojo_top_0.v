...
module mojo_top_0 (
  ...
  wire [1-1:0] M_detectTest_out;
  reg [1-1:0] M_detectTest_in;
  edge_detector_3 detectTest (
    .clk(clk),
    .in(M_detectTest_in),
    .out(M_detectTest_out)
  );
  wire [1-1:0] M_buttonTest_out;
  reg [1-1:0] M_buttonTest_in;
  button_conditioner_13 buttonTest (
    .clk(clk),
    .in(M_buttonTest_in),
    .out(M_buttonTest_out)
  );
  reg M_test_led0_d, M_test_led0_q = 1'h0;
  reg M_test_led1_d, M_test_led1_q = 1'h0;
  reg M_test_led2_d, M_test_led2_q = 1'h0;
  reg M_test_led3_d, M_test_led3_q = 1'h0;
  reg M_test_led4_d, M_test_led4_q = 1'h0;
  reg M_test_led5_d, M_test_led5_q = 1'h0;
  reg M_test_led6_d, M_test_led6_q = 1'h0;
  reg M_test_led7_d, M_test_led7_q = 1'h0;
  reg M_test_led8_d, M_test_led8_q = 1'h0;
  ...
  always @* begin
    ...
    M_test_led3_d = M_test_led3_q;
    M_test_led2_d = M_test_led2_q;
    M_test_led5_d = M_test_led5_q;
    M_test_led4_d = M_test_led4_q;
    M_test_led1_d = M_test_led1_q;
    M_test_led0_d = M_test_led0_q;
    M_test_led7_d = M_test_led7_q;
    M_test_led6_d = M_test_led6_q;
    M_test_led8_d = M_test_led8_q;
    
    M_buttonTest_in = test_button;
    M_detectTest_in = M_buttonTest_out;
    io_led = io_dip;
    io_led[0+0+0-:1] = M_test_led0_q;
    io_led[0+1+0-:1] = M_test_led1_q;
    io_led[0+2+0-:1] = M_test_led2_q;
    io_led[0+3+0-:1] = M_test_led3_q;
    io_led[0+4+0-:1] = M_test_led4_q;
    io_led[0+5+0-:1] = M_test_led5_q;
    io_led[0+6+0-:1] = M_test_led6_q;
    io_led[0+7+0-:1] = M_test_led7_q;
    io_led[8+0+0-:1] = M_test_led8_q;
    ...
    case (M_states_q)
      START_states: begin
        ...
        if (M_detectTest_out == 1'h1) begin
  ...
  always @(posedge clk) begin
    if (rst == 1'b1) begin
      ...
      M_test_led0_q <= M_test_led0_d;
      M_test_led1_q <= M_test_led1_d;
      M_test_led2_q <= M_test_led2_d;
      M_test_led3_q <= M_test_led3_d;
      M_test_led4_q <= M_test_led4_d;
      M_test_led5_q <= M_test_led5_d;
      M_test_led6_q <= M_test_led6_d;
      M_test_led7_q <= M_test_led7_d;
      M_test_led8_q <= M_test_led8_d;
